...
for time_index_index = firstTime:lastTime  % time 78 takes a LONG time
    ...
    if bStoredReg
        ...
        rot1s = rand(3*maxItr,1);
        rot2s = rand(3*maxItr,1);
        rot3s = rand(3*maxItr,1);
